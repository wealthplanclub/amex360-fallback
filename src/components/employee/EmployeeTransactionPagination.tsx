...
interface EmployeeTransactionPaginationProps {
  table: Table<EmployeeTransaction>
  showAll: boolean
...
export function EmployeeTransactionPagination({ 
  table, 
  showAll, 
  filteredRowCount, 
  onShowAll, 
  onShowPaginated 
}: EmployeeTransactionPaginationProps) {
  return (
