  ...
  const calculations = React.useMemo(() => {
    ...
    return transactionCacheService.getCachedCalculations(
      ...
      () => {
        ...
        // Calculate expenses (negative amounts - actual spending)
        ...
        // Calculate credits/payments (positive amounts - payments made)
        ...
        // Calculate card expenses grouped by account (only negative amounts for spending)
