...
export let employeeCardBonuses: EmployeeCardBonus[] = [
  // Blue Plus I cards - using real last five digits from employee data
  ...
  { cardKey: "Blue Plus I--01000", cardType: "Blue Plus I", lastFive: "-01000", hasBonus: true },

  // Blue Plus II cards
  { cardKey: "Blue Plus II--11025", cardType: "Blue Plus II", lastFive: "-11025", hasBonus: true },

  // Classic Gold cards - using real last five digits
  { cardKey: "Classic Gold--72067", cardType: "Classic Gold", lastFive: "-72067", hasBonus: true },

  // Rose Gold cards - using real last five digits from employee data
  ...
  // Platinum cards - using real last five digits from employee data
